 // ExtendScript Memory
 // Not sure it is relevant to your question but I have an old snippet that collects and displays ExtendScript references using $.list(). 
 // This may help to track some object relationships.
