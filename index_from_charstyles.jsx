...
//~ 		}
	...
	if (errors) {
		...
		app.findTextPreferences.appliedConditions = [app.documents[0].conditions.item ('index_from_charstyles_error')];
		alert ('One or more errors encountered. Look for instances of the text condition "index_from_charstyles_error", fix the problems, and run the script again.');
	} else {
		alert ('Done.');
	}
